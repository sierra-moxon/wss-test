# Contributing to wss-test

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
wss-test. These guidelines are not strict rules.
...
The wss-test team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the wss-test technical leads
...
[issues]: https://github.com/sierra-moxon/wss-test/issues/
[pulls]: https://github.com/sierra-moxon/wss-test/pulls/
