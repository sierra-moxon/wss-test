...
class Dataset(ConfiguredBaseModel):
    ...
    description: Optional[str] = Field(default=None, description="""A free-text description.""", json_schema_extra = { "linkml_meta": {'alias': 'description', 'domain_of': ['Dataset']} })
    variables: Optional[List[Variable]] = Field(default=None, description="""Variable definitions used by measurements in this dataset.""", json_schema_extra = { "linkml_meta": {'alias': 'variables', 'domain_of': ['Dataset']} })
    samples: Optional[List[Sample]] = Field(default=None, description="""The samples included in this dataset.""", json_schema_extra = { "linkml_meta": {'alias': 'samples', 'domain_of': ['Dataset']} })
...
class Sample(ConfiguredBaseModel):
    ...
    id: str = Field(default=..., description="""A unique identifier.""", json_schema_extra = { "linkml_meta": {'alias': 'id', 'domain_of': ['Dataset', 'Sample', 'Attribute']} })
    name: Optional[str] = Field(default=None, description="""A human-readable name.""", json_schema_extra = { "linkml_meta": {'alias': 'name', 'domain_of': ['Dataset', 'Sample']} })
    site_code: Optional[str] = Field(default=None, description="""Code identifying the sampling site (e.g. CM_003, CM_004).""", json_schema_extra = { "linkml_meta": {'alias': 'site_code', 'domain_of': ['Sample']} })
    medium: Optional[str] = Field(default=None, description="""The environmental medium or matrix sampled (e.g. OCN for ocean water).""", json_schema_extra = { "linkml_meta": {'alias': 'medium', 'domain_of': ['Sample']} })
    replicate: Optional[int] = Field(default=None, description="""Replicate number within a site and medium.""", json_schema_extra = { "linkml_meta": {'alias': 'replicate', 'domain_of': ['Sample']} })
    measurements: Optional[List[Measurement]] = Field(default=None, description="""The measurements performed on this sample.""", json_schema_extra = { "linkml_meta": {'alias': 'measurements', 'domain_of': ['Sample']} })
...
class AttributeValue(ConfiguredBaseModel):
    ...
    attribute: str = Field(default=..., description="""The attribute being represented.""", json_schema_extra = { "linkml_meta": {'alias': 'attribute',
...
class Attribute(ConfiguredBaseModel):
    ...
    id: str = Field(default=..., description="""A unique identifier.""", json_schema_extra = { "linkml_meta": {'alias': 'id', 'domain_of': ['Dataset', 'Sample', 'Attribute']} })
    label: str = Field(default=..., description="""Text string to describe the attribute.""", json_schema_extra = { "linkml_meta": {'alias': 'label', 'aliases': ['title'], 'domain_of': ['Attribute']} })
...
class QuantityValue(AttributeValue):
    ...
    numeric_value: Optional[float] = Field(default=None, description="""The numerical part of a quantity value.""", json_schema_extra = { "linkml_meta": {'alias': 'numeric_value',
         'aliases': ['result_value'],
         'domain_of': ['QuantityValue'],
         'mappings': ['nmdc:numeric_value',
                      'qud:quantityValue',
                      'schema:value',
                      'bertron:numeric_value']} })
    unit: Optional[str] = Field(default=None, description="""Unit of measurement, ideally as a Unit Ontology CURIE.""", json_schema_extra = { "linkml_meta": {'alias': 'unit',
         'domain_of': ['QuantityValue'],
         'mappings': ['nmdc:unit',
                      'qud:unit',
                      'schema:unitCode',
...
class TextValue(AttributeValue):
    ...
    value: Optional[str] = Field(default=None, description="""The value, as a text string.""", json_schema_extra = { "linkml_meta": {'alias': 'value', 'domain_of': ['TextValue'], 'mappings': ['bertron:value']} })
...
class Variable(Attribute):
    ...
    id: str = Field(default=..., description="""Canonical identifier for this variable (e.g. carbon_dissolved_organic).""", json_schema_extra = { "linkml_meta": {'alias': 'id', 'domain_of': ['Dataset', 'Sample', 'Attribute']} })
    label: str = Field(default=..., description="""Text string to describe the attribute.""", json_schema_extra = { "linkml_meta": {'alias': 'label', 'aliases': ['title'], 'domain_of': ['Attribute']} })
...
class Measurement(QuantityValue):
    ...
    method_id: Optional[str] = Field(default=None, description="""Identifier for the analytical method used to produce the measurement.""", json_schema_extra = { "linkml_meta": {'alias': 'method_id', 'domain_of': ['Measurement']} })
    flag: Optional[str] = Field(default=None, description="""Quality assurance flag associated with the measurement.""", json_schema_extra = { "linkml_meta": {'alias': 'flag', 'domain_of': ['Measurement']} })
    datetime_measured: Optional[datetime ] = Field(default=None, description="""Date and time when the measurement was taken.""", json_schema_extra = { "linkml_meta": {'alias': 'datetime_measured', 'domain_of': ['Measurement']} })
    statistic: Optional[str] = Field(default=None, description="""The summary statistic applied to the measurement, if any (e.g. mean, median).""", json_schema_extra = { "linkml_meta": {'alias': 'statistic', 'domain_of': ['Measurement']} })
    temporal_aggregation: Optional[str] = Field(default=None, description="""The time interval over which the statistic was aggregated (e.g. daily, 15-min).""", json_schema_extra = { "linkml_meta": {'alias': 'temporal_aggregation', 'domain_of': ['Measurement']} })
    reported_precision: Optional[float] = Field(default=None, description="""The precision of the reported result value.""", json_schema_extra = { "linkml_meta": {'alias': 'reported_precision', 'domain_of': ['Measurement']} })
    notes: Optional[str] = Field(default=None, description="""Free-text notes about the measurement.""", json_schema_extra = { "linkml_meta": {'alias': 'notes', 'domain_of': ['Measurement']} })
    numeric_value: float = Field(default=..., description="""The numerical part of a quantity value.""", json_schema_extra = { "linkml_meta": {'alias': 'numeric_value',
         ...
         'mappings': ['nmdc:numeric_value',
                      ...
                      'schema:value',
                      'bertron:numeric_value']} })
    unit: str = Field(default=..., description="""Unit of measurement, ideally as a Unit Ontology CURIE.""", json_schema_extra = { "linkml_meta": {'alias': 'unit',
         'domain_of': ['QuantityValue'],
         'mappings': ['nmdc:unit',
                      'qud:unit',
                      'schema:unitCode',
    ...
    unit_cv_id: Optional[str] = Field(default=None, description="""The unit of the quantity, expressed as a CURIE from the Unit Ontology.""", json_schema_extra = { "linkml_meta": {'alias': 'unit_cv_id',
         'domain_of': ['QuantityValue'],
         'mappings': ['bertron:unit_cv_id']} })
    attribute: str = Field(default=..., description="""The variable being measured, as a reference to a Variable definition.""", json_schema_extra = { "linkml_meta": {'alias': 'attribute',
         'domain_of': ['AttributeValue'],
         'mappings': ['bertron:attribute']} })
    raw_value: Optional[str] = Field(default=None, description="""The value that was specified for an annotation in raw form, i.e. a string. E.g. \"2 cm\" or \"2-4 cm\"""", json_schema_extra = { "linkml_meta": {'alias': 'raw_value',
         'domain_of': ['AttributeValue'],
